...
<html lang="en">
  <head>
    ...
    <script>
      ...
      const CONFIGURATION = {
        ...
        "pois": [
          {"placeId": "ChIJz-BJCv6nlVQRLR_HZ6rp-pU"},
          {"placeId": "ChIJk1TvjAColVQRtsE6rwqfcDE"},
          {"placeId": "ChIJP20DvTiplVQRv5dp2RqxbrI"}
        ],
        "mapRadius": 2000,
        "mapOptions": {"center":{"lat":45.6008356,"lng":-122.760606},"fullscreenControl":true,"mapTypeControl":true,"streetViewControl":false,"zoom":16,"zoomControl":true,"maxZoom":20,"mapId":""},
        "mapsApiKey": "AIzaSyD7n6Bqi7eREDoJEBuxseVHPqhweiY4GQo"
      };
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD7n6Bqi7eREDoJEBuxseVHPqhweiY4GQo&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_neighborhooddiscovery_v2_cADEF" async defer></script>
  </body>
</html>